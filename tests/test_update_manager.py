...
def test_release_info_accepts_only_matching_installer_version(tmp_path: Path) -> None:
    ...
    payload = {
        ...
        "html_url": "https://github.com/XDSawyerLoL/Auralive/releases/tag/quantic-studio-v2.8.2",
        "published_at": "2026-09-21T10:00:00Z",
        "assets": [
            {
                "name": "QuanticStudio-Setup-9.9.9.exe",
                "browser_download_url": "https://github.com/XDSawyerLoL/Auralive/releases/download/quantic-studio-v2.8.2/QuanticStudio-Setup-9.9.9.exe",
                "digest": "sha256:" + ("0" * 64),
                "size": 123,
            },
            {
                "name": "QuanticStudio-Setup-2.8.2.exe",
                "browser_download_url": "https://github.com/XDSawyerLoL/Auralive/releases/download/quantic-studio-v2.8.2/QuanticStudio-Setup-2.8.2.exe",
                "digest": "sha256:" + ("a" * 64),
                "size": 456,
            },
        ],
    ...
    assert info["latest_version"] == "2.8.2"
    assert info["update_available"] is True
    assert info["installer_available"] is True
    assert info["installer"]["name"] == "QuanticStudio-Setup-2.8.2.exe"
