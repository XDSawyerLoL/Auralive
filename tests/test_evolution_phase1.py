...
def test_packaged_env_does_not_force_evolution_on_windows():
    ...
    assert "AURA_EVOLUTION_ENABLED=true" not in active_lines
    assert "AURA_EVOLUTION_ENABLED=false" not in active_lines
