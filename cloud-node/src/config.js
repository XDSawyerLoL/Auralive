...
export const config = Object.freeze({
  ...
  curiosityTickSeconds: int('AURA_CURIOSITY_TICK_SECONDS', 90, 30, 86400),
  curiosityWarmupSeconds: int('AURA_CURIOSITY_WARMUP_SECONDS', 20, 10, 600),
  curiosityQuestionsPerCycle: int('AURA_CURIOSITY_QUESTIONS_PER_CYCLE', 5, 1, 8),
  curiosityResearchPerCycle: int('AURA_CURIOSITY_RESEARCH_PER_CYCLE', 2, 0, 4),
  curiosityMaxQuestionsPerHour: int('AURA_CURIOSITY_MAX_QUESTIONS_PER_HOUR', 24, 1, 60),
  curiosityMaxWebResearchPerHour: int('AURA_CURIOSITY_MAX_WEB_RESEARCH_PER_HOUR', 8, 0, 20),
  curiosityMaxInterlocutorQuestionsPerHour: int('AURA_CURIOSITY_MAX_INTERLOCUTOR_QUESTIONS_PER_HOUR', 2, 0, 12),
  curiosityProductStaleSeconds: int('AURA_CURIOSITY_PRODUCT_STALE_SECONDS', 360, 60, 86400),
