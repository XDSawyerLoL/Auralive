...
class Settings:
    ...
    # AURA Evolution: active par défaut en phase 1 "observe".
    # Observe = recherche + diagnostic uniquement : aucun fichier modifié,
    # aucun patch exécuté, aucune PR ni fusion automatique.
